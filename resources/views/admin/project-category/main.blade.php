            ...
            <div class="card" style="border-radius: 16px;">
                <div class="card-header bg-white d-flex justify-content-between align-items-center py-4 px-4">
                    <div class="title d-flex flex-column">
                        <span style="font-weight: bold; font-size: 16px;">Project Categories</span>
                        <small>Menu manajemen kategori projek pada modul projek.</small>
                    </div>
                    <a href="{{route('project-category.create')}}" class="button btn __bg-primary px-3 py-2 d-flex align-items-center" style="font-size: 14px;"><i data-feather="plus-circle" class="me-2"></i> Add New Record</a>
                </div>
                <div class="card-body row">
                    ...
                    <div class="card p-3 col-3 d-flex flex-row justify-content-between align-items-center">
                        ...
                        <div class="actions d-flex flex-row">
                            <a href="{{ route('project-category.edit', $val->id) }}" class="btn btn-sm btn-warning me-2">
                                <i data-feather="edit"></i>
                            </a>
                            <form action="{{ route('project-category.destroy', $val->id) }}" method="POST">
                                @CSRF
                                @method('DELETE')
