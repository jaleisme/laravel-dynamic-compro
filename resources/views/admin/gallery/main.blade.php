            ...
            <div class="card" style="border-radius: 16px;">
                <div class="card-header bg-white d-flex justify-content-between align-items-center py-4 px-4">
                    <div class="title d-flex flex-column">
                        <span style="font-weight: bold; font-size: 16px;">Gallery Section Management</span>
                        <small>Menu manajemen konten di section gallery.</small>
                    </div>
                    <a href="{{route('gallery.create')}}" class="button btn __bg-primary px-3 py-2 d-flex align-items-center" style="font-size: 14px;"><i data-feather="plus-circle" class="me-2"></i> Add New Record</a>
                </div>
                        ...
                        <div class="card-img-overlay d-flex flex-column justify-content-between p-3" style="background: rgb(15,15,15); background: linear-gradient(0deg, rgba(15,15,15,1) 0%, rgba(255,255,255,0) 100%);">
                            <div class="top d-flex justify-content-between">
                                ...
                                <div class="actions d-flex flex-row">
                                    <a href="{{ route('gallery.edit', $val->id) }}" class="btn btn-sm btn-warning me-2">
                                        <i data-feather="edit"></i>
                                    </a>
                                    <form action="{{ route('gallery.destroy', $val->id) }}" method="POST">
                                        @CSRF
                                        @method('DELETE')
